  ...
  const options = {
    defaults: {
      global: {
        ...
        defaultColor: (mode) ? colors.gray[700] : colors.gray[600],
        // tslint:disable-next-line:triple-equals
        defaultFontColor: (mode) ? colors.gray[700] : colors.gray[600],
        ...
        elements: {
          ...
          arc: {
            backgroundColor: colors.theme['primary'],
            borderColor: (mode) ? colors.gray[800] : colors.white,
            borderWidth: 4
          }
        },
        tooltips: {
...
const lineS = [
  {label: '0', number: 0},
  {label: ' Intership', number: 5},
  {label: 'Fresher', number: 10},
  {label: 'Junior', number: 15},
  {label: 'Middle', number: 20},
  {label:  'Senior', number: 25}];
...
export const chartExample2 = {
      ...
      yAxes: [
        {
          ticks: {
            callback: function(value, data) {
              // So sánh data number và arr label
              let content = '';
              for (let k = 0; k < lineS.length; k++) {
                // @ts-ignore
                if (lineS[k].number === value) {
                  content += lineS[k].label;
                }
              }
              return content;
            }
  ...
  data: {
    labels: ['Java', 'Spring Boot', 'MariaDB', 'Oracle', 'MySQL'],
    datasets: [
      {
        label: 'Sales',
